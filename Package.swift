...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      name: "DTExchangeAdapter",
      url:
        "https://dl.google.com/googleadmobadssdk/mediation/ios/dtexchange/DTExchangeAdapter-8.4.8.0.zip",
      checksum: "f858226787bab1e5586205debabd117c401ebbff031094c9ccf7e9bddf851b86"
    ),
  ]
)
